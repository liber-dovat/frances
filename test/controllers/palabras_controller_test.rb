...
class PalabrasControllerTest < ActionController::TestCase
  ...
  test "should create palabra" do
    assert_difference('Palabra.count') do
      post :create, palabra: { definicion: @palabra.definicion, ejemplo1: @palabra.ejemplo1, ejemplo2: @palabra.ejemplo2, mot: @palabra.mot }
    end
  ...
  test "should update palabra" do
    patch :update, id: @palabra, palabra: { definicion: @palabra.definicion, ejemplo1: @palabra.ejemplo1, ejemplo2: @palabra.ejemplo2, mot: @palabra.mot }
    assert_redirected_to palabra_path(assigns(:palabra))
  end
